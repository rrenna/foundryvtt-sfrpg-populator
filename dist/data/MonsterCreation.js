...
(function (MonsterSkillType) {
    MonsterSkillType[MonsterSkillType["good"] = 0] = "good";
    MonsterSkillType[MonsterSkillType["master"] = 1] = "master";
...
export const MonsterCreation = {
    ...
    specialAbilities: {
        ...
        adjustment: {
            brute: new AdjustmentSpecialAbility("brute", "Use the low attack value for the NPC’s main attack, but determine the attack’s damage as if the NPC’s CR were 2 higher (adding the extra damage from weapon specialization). This special ability has a greater impact at higher CRs."),
            extraHitPoints: new AdjustmentSpecialAbility("extra hit points", "Increase the NPC’s HP by 20%."),
            saveBoost: new AdjustmentSpecialAbility("save boost", "Increase all saving throw bonuses by 1 or one saving throw bonus by 3."),
            //TODO: Secondary Magic
            skillful: new AdjustmentSpecialAbility("skillful", "Increase all master and good skill bonuses by 1.")
        }
    }
};
