...
export const Races = {
    ...
    nonCombatantRaces: {
        android: new Race("android", Size.medium, Grafts.creatureType.humanoid, Grafts.creatureSubtype.android),
        dwarf: new Race("dwarf", Size.medium, Grafts.creatureType.humanoid, Grafts.creatureSubtype.dwarf, ["dwarven"]),
        drow: new Race("drow", Size.medium, Grafts.creatureType.humanoid, Grafts.creatureSubtype.elf, ["drow"]),
        ...
        halfling: new Race("halfling", Size.small, Grafts.creatureType.humanoid, Grafts.creatureSubtype.halfling, ["halfling"]),
        kasatha: new Race("kasatha", Size.medium, Grafts.creatureType.humanoid, Grafts.creatureSubtype.kasatha, ["kasatha"], undefined, 4),
        lashunta: new Race("lashunta", Size.medium, Grafts.creatureType.humanoid, Grafts.creatureSubtype.lashunta, ["castrovelian"]),
        nuar: new Race("nuar", Size.medium, Grafts.creatureType.monstrousHumanoid),
        skittermander: new Race("skittermander", Size.small, Grafts.creatureType.humanoid, Grafts.creatureSubtype.skittermander, undefined, undefined, 6),
        shirren: new Race("shirren", Size.medium, Grafts.creatureType.humanoid, Grafts.creatureSubtype.shirren, ["shirren"]),
        vesk: new Race("vesk", Size.medium, Grafts.creatureType.humanoid, Grafts.creatureSubtype.vesk, ["vesk"]),
        ysoki: new Race("ysoki", Size.small, Grafts.creatureType.humanoid, Grafts.creatureSubtype.ysoki, ["akiton", "ysoki"])
    }
};
