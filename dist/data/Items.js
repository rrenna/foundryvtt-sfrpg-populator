...
export const Items = {
    junk: [
        { name: "Old ticket to see Strawberry Machine Cake", description: "" },
        {
            ...
            description: "'Take it to the EJ' is written on the bottom of this red stapler."
        },
        ...
        {
            name: "Memory card",
            description: "A memory card for an unrecognized technological device."
        },
        ...
        {
            name: "Keychain",
            description: "A keychain holding keys for a series of unknown archaic locks."
        },
        ...
        {
            name: "ID card",
            description: "A semi-official ID card proving membership in a local club."
        },
        {
            name: "Candy",
...
export const backpackTemplate = {
    ...
    data: {
        description: {
            ...
            gmnotes: "",
            short: "",
            value: '<p><span id="ctl00_MainContent_DataListOtherItems_ctl00_LabelName">When wearing a properly fitted consumer backpack, you treat your Strength score as 1 higher for the purpose of determining your carrying capacity.&nbsp;</span></p>',
            unidentified: ""
        },
...
export const canteenTemplate = {
    ...
    data: {
        description: {
            ...
            gmnotes: "",
            short: "",
            value: '<p><span id="ctl00_MainContent_DataListOtherItems_ctl00_LabelName">This hollow plastic or metal container can hold up to a half gallon of liquid.&nbsp;</span></p>',
            unidentified: ""
        },
        source: "Armory",
        type: "",
