...
export const Grafts = {
    ...
    creatureSubtype: {
        ...
        vesk: new CreatureSubtypeGraft(Subtype[Subtype.vesk], "This subtype is applied to vesk and creatures related to vesk. <br/><b>Traits:</b> Low-light vision; if the NPC is of the vesk race (Starfinder Core Rulebook 52), it also gains the armor savant, fearless, and natural weapons racial traits."),
        ysoki: new CreatureSubtypeGraft(Subtype[Subtype.ysoki], "This subtype is applied to ysoki and creatures related to ysoki. <br/><b>Traits</b>: Darkvision 60 ft.; if the NPC is of the ysoki race (Starfinder Core Rulebook 54), it also gains the cheek pouches and moxie racial traits, Engineering and Stealth as master skills, and Survival as a good skill.")
    }
};
