...
export default class PopulatorPanelController extends Application {
    ...
    activateListeners(html) {
        ...
        html.find(".npcGenerationButton").on('click', this.npcGenerationButtonClicked.bind(this));
        html.find(".monsterGenerationButton").on('click', this.monsterGenerationButtonClicked.bind(this));
    }
    /**
    ...
    monsterGenerationButtonClicked(e) {
