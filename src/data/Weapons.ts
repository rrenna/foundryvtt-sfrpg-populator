...
export const unarmedStrikeTemplate = {
    ...
    system: {
        description: {
            ...
            short: "",
            value:
                "<p>An unarmed strike can be dealt with any limb or appendage. Unarmed strikes deal nonlethal damage, and the damage from an unarmed strike is considered weapon damage for the purposes of effects that give you a bonus to weapon damage rolls.</p>",
            unidentified: ""
        },
        source: "CRB pg. 190",
        type: "",
...
export const naturalWeaponsTemplate = {
    ...
    system: {
        description: {
            ...
            short: "",
            value:
                "<p>Natural weapons (and natural attacks) such as acid spit, bite, claw, or slam don’t require ammunition and can’t be disarmed or sundered.\n" +
