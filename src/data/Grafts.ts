...
export const Grafts = {
    ...
    creatureSubtype: {
        ...
        shirren: new CreatureSubtypeGraft(
            ...
            "This subtype is applied to shirrens and creatures related to shirrens. <br/><b>Traits:</b> Blindsense (vibration) 30 ft.; if the NPC is of the shirren species (Starfinder Core Rulebook 50), it also gains the communalism and limited telepathy racial traits and Culture and Diplomacy as good skills."
        ),
        skittermander: new CreatureSubtypeGraft(
            Subtype[Subtype.skittermander],
            "This subtype is applied to skittermanders and creatures related to skittermanders. <br/><b>Traits:</b>Traits:</b> Low-light vision; if the NPC is of the skittermander species (see page 106), it also gains the grappler, hyper, and six- armed racial traits."
        ),
        ...
        vesk: new CreatureSubtypeGraft(
            ...
            "This subtype is applied to vesk and creatures related to vesk. <br/><b>Traits:</b> Low-light vision; if the NPC is of the vesk species (Starfinder Core Rulebook 52), it also gains the armor savant, fearless, and natural weapons racial traits."
        ),
        ysoki: new CreatureSubtypeGraft(
            Subtype[Subtype.ysoki],
            "This subtype is applied to ysoki and creatures related to ysoki. <br/><b>Traits</b>: Darkvision 60 ft.; if the NPC is of the ysoki species (Starfinder Core Rulebook 54), it also gains the cheek pouches and moxie racial traits, Engineering and Stealth as master skills, and Survival as a good skill."
        )
    }
}
