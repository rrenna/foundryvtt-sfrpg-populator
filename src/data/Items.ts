export const Items = {
    ...
    junk: [
        ...
        {name:"EJ Corp branded stapler", description: "'Take it to the EJ' is written on the bottom of this red stapler."},
        ...
        {name:"Bottle of water", description: "Water in a plastic bottle. Mostly empty."},
        {name:"Stylus", description: "A stylus for an unrecognized technological device."},
        {name:"Memory card", description: "A memory card for an unrecognized technological device."},
        ...
        {name:"Broken battery cell", description: "A battery cell in need of repair and out of power."},
        {name:"Keychain", description: "A keychain holding keys for a series of unknown archaic locks."},
        {name:"Headphones", description: "A wired set of headphones."},
        {name:"A faux-gold ring", description: "Some strange elven script is written inside the band."},
        {name:"Lint", description: "An accumulation of fibers and other materials."},
        {name:"ID card", description: "A semi-official ID card proving membership in a local club."},
        {name:"Candy", description: "Wrapped candy which appears to be from a restaurant."},
